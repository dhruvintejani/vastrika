  ...
  return (
    <footer className="bg-[#1F1F1F] text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2">
            ...
            >
              ...
              <div>
                <span className="block font-heading text-3xl font-semibold text-white tracking-wide leading-none">
                  Vastrika
                </span>

                <span className="block font-body text-[9px] font-bold text-[#C9A86A] tracking-[0.32em] mt-1">
                  ETHNIC FASHION
                </span>

                <span className="block w-32 h-0.5 bg-[#C9A86A] mt-1.5 rounded-full" />
              </div>
            </Link>

            <p className="font-body text-sm text-white/60 leading-relaxed mb-6 max-w-xs">
              Celebrating the timeless beauty of Indian ethnic fashion.
              Handcrafted with love, inspired by heritage, designed for the
              modern Indian woman.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="font-body text-xs text-white/40">
            © 2026 Vastrika. All rights reserved. Made in India.
          </p>

          <div className="flex items-center gap-4">
            <span className="font-body text-xs text-white/40 bg-white/10 px-2 py-1 rounded">
              UPI
            </span>
            <span className="font-body text-xs text-white/40 bg-white/10 px-2 py-1 rounded">
              COD
