...
//               src="/logo.svg"
//               alt="Vastrika"
//               className="h-11 w-auto max-w-[152px] sm:max-w-[176px] object-contain"
//             />
//           </Link>
...
//                 className={`w-5 h-5 transition-colors ${
//                   wishlist.length > 0
//                     ? 'text-[#C58C85] fill-[#C58C85]'
//                     : 'text-[#1F1F1F] group-hover:text-[#C58C85]'
//                 }`}
//               />
...
//                     >
//                       <div className="px-4 py-3 border-b border-[#F0EBE3]">
//                         <p className="font-body text-sm font-semibold text-[#1F1F1F] truncate">
//                           {user?.full_name}
//                         </p>
//                         <p className="font-body text-xs text-[#999] truncate">{user?.email}</p>
//                       </div>
...
//                     <Link
//                       to="/orders"
//                       className="block py-3 px-4 rounded-lg text-sm font-body font-medium text-[#1F1F1F] hover:bg-[#EFE7DC] hover:text-[#7A4E48] transition-colors"
//                     >
//                       My Orders
//                     </Link>
...
//                     <Link
//                       to="/login"
//                       className="block py-3 px-4 rounded-lg text-sm font-body font-medium text-[#7A4E48] hover:bg-[#EFE7DC] transition-colors"
//                     >
//                       Sign In
//                     </Link>
...
//                     <Link
//                       to="/register"
//                       className="block py-3 px-4 rounded-lg text-sm font-body font-medium text-[#555] hover:bg-[#EFE7DC] transition-colors"
//                     >
//                       Create Account
//                     </Link>
//                   </>
